x<?php
    ...
    final class RouteRegistry
    {
        ...
        private static RouteCollectorProxyInterface $inner_group;
        private static RouteInterface $outer_group;
        ...
        public final static function setup(
            ...
            $group = self::$app->group(
                ...
                function (RouteCollectorProxy $group) {
                    ...
                    self::setInner_group($group);
                }
            );

            self::setOuter_group($group);
        }
         ...
         */
        public static function getInner_group()
        {
            return self::$inner_group;
        }

        /**
         * Set the value of inner_group
         *
         * @return  self
         */
        public static function setInner_group($inner_group)
        {
        ...
        public static function getOuter_group()
        {
            return self::$outer_group;
        }


        public static function setOuter_group($outer_group)
        {

            self::$outer_group = $outer_group;
        }
        ...
        public static function get(string $pattern, callable | array $callable)
        {
            ...
            return self::getInner_group()->get($pattern, $callable);
        }
        ...
        public static function post(string $pattern, callable | array $callable)
        {
            ...
            return self::getInner_group()->post($pattern, $callable);
        }
        ...
        public static function patch(string $pattern, callable | array $callable)
        {
            ...
            return self::getInner_group()->patch($pattern, $callable);
        }
        ...
        public static function delete(string $pattern, callable | array $callable)
        {
            ...
            return self::getInner_group()->delete($pattern, $callable);
        }
        ...
        public static function put(string $pattern, callable | array $callable)
        {
            ...
            return self::getInner_group()->put($pattern, $callable);
        }
        ...
        public static function any(string $pattern, callable | array $callable)
        {
            ...
            return self::getInner_group()->any($pattern, $callable);
        }
        ...
        public static function options(string $pattern, callable | array $callable)
        {
            ...
            return self::getInner_group()->options($pattern, $callable);
        }
        ...
        static function resource(string $path, string $class_name): void
        {
            ...
            $group = self::getInner_group()->group(
                $path,
